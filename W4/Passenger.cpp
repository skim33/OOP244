...
namespace sict {
	...
	//This constructor stores data after validation.
	//If validation fails, it sets the object to a safe empty state.
	...
	//It returns the address of the name of the passenger.
	const char* Passenger::name() const {
		return p_name;
	}

	//This function checks if the passenger referenced can travel with the current Passenger.
